def createDisplayTxt():
    ...
    #    file1.write("Path to Private Key: %s \n" % (PrivateKey))
        ...
        file1.write("Sequential read Band width: %s \n" % (lines[6]))
        file1.write("Sequential Write IOPs: %s \n" % (lines[7]))
        file1.write("Sequential Write Band Width: %s \n" % (lines[8]))
        file1.write("Random Read IOPs: %s \n" % (lines[9]))
        file1.write("Random read Band Width: %s \n" % (lines[10]))
        file1.write("Random Write IOPs: %s \n" % (lines[11]))
        file1.write("Random Write Band Width: %s \n" % (lines[12]))
        file1.write("Random Read/Write Read IOPs: %s \n" % (lines[13]))
        file1.write("Random Read/Write Read Band Width: %s \n" % (lines[14]))
        file1.write("Random Read/Write Write IOPs: %s \n" % (lines[15]))
        file1.write("Random Read/Write Write Band Width: %s \n" % (lines[16]))
